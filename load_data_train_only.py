...
df = pd.read_csv("files/train.csv", sep=';', encoding='utf8') #En cas d'erreur essayez avec d'autres encodings
...
df_bert.to_csv('files/test.tsv', sep='\t', index=False, header=True)